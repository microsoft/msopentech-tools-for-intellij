...
public class BrowserLauncher {
    ...
    public void browse() {
        DefaultLoader.getIdeHelper().invokeAuthLauncherTask(project, this, windowTitle);
    }

    public void launch(File appJar) throws NoSuchMethodException, InterruptedException, IOException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
    ...
    public void reportError(Throwable err) {
        DefaultLoader.getUIHelper().showException("An error occurred while loading authentication components.",
                err,
