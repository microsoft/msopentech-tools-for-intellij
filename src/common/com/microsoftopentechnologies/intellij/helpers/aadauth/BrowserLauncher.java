...
public class BrowserLauncher {
    ...
    void launch(File appJar) throws NoSuchMethodException, InterruptedException, IOException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
    ...
    void reportError(Throwable err) {
        DefaultLoader.getUIHelper().showException("An error occurred while loading authentication components.", err);
    }
}
