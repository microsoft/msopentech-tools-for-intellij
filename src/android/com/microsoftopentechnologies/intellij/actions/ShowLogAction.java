...
public class ShowLogAction extends AnAction {
    ...
    private Service getSelectedScript(AnActionEvent event) {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        final Service selectedService = getSelectedScript(e);

        if(selectedService != null) {
            ApplicationManager.getApplication().invokeLater(new Runnable() {
                @Override
                public void run() {
                    form.queryLog(selectedService.getSubcriptionId(), selectedService.getName());
                }
            });
